...
> **复核说明（2026-08-23）**：本文前半部分保留 2026-08-21 的问题基线，风险表中标为“已修复/部分缓解”的项目以本文第 17 节为准。当前代码已在后续版本扩展到 Flyway V8 和 SOAR MVP；当前能力必须回到 `current-status.md`、`product-contract.md` 和 `soar.md`，不要从本归档推断。
...
当前文档基线已更新为根项目 81、Flink 33；本归档文件保留当时的审计过程，历史验证数字不回写。
