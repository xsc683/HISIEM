...
public class AgentLaunchService {
    ...
    private final String investigationRouteBase;
    ...
    public AgentLaunchResponse launch(String taskType, String resourceType, String resourceId,
        ...
        Map<String, Object> sourceAlertRef = new LinkedHashMap<>();
        sourceAlertRef.put("provider", "hisiem");
        sourceAlertRef.put("resource_type", resourceType);
        sourceAlertRef.put("address_id", addressId);

        Map<String, Object> payload = new LinkedHashMap<>();
        payload.put("source_alert_ref", sourceAlertRef);
    ...
    private AgentLaunchResponse parseLaunchResponse(String body) {
        try {
            ...
            String investigationId = json.path("investigation_id").asText();
